...
namespace
{
  std::string test_serialized_keys = MAKE_STR(
    ...
    "\x00");
  std::string test_keys_addr_str = "Px3NV3xE8bLY5yQcdApjMb8tVPik5BC3LFdaevfbGq7X1KY5vdsWmUi5UQgse2GBZFbMsb47TFqBmPpdFHDDwDxR2ZuZ6qBBb"; // correct str address depends on CURRENCY_PUBLIC_ADDRESS_BASE58_PREFIX value
}
